...
namespace Organizer.Lib.Core.Providers;
...
public class AuthStateProvider : AuthenticationStateProvider
{
    ...
    {
        var authenticatedUser = new ClaimsPrincipal(new ClaimsIdentity(new[] { new Claim(ClaimTypes.NameIdentifier, userId) }, "jwtAuthType"));
